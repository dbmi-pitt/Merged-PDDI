...
Interaction Knowledge Base (DIKB)
		...
		<p>
		  Download 14 sources merged PDDI datasets:
		...
		<p>
		  This site will help you locate interactions between two prescription drugs. Below, enter the drugs you would like to search for, then select the type of sources and type of information you are interested in viewing.</p>	
            </div>
